...
public enum ErrorCode {
    ...
    ERR_1004(HttpStatus.UNAUTHORIZED, "INVALID_TOKEN", "1004", "User is missing from Bearer Token"),
    ERR_1005(HttpStatus.TOO_MANY_REQUESTS, "TOO_MANY_REQUESTS", "1005", "Rate limit exceeded.");
